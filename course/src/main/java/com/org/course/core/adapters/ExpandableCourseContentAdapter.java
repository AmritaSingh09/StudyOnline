...
public class ExpandableCourseContentAdapter extends BaseExpandableListAdapter {
    ...
    // constructor
    public ExpandableCourseContentAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int lstPosn, final int expanded_ListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.item_course_list, null);
        }
        TextView expandedListTextView = (TextView) convertView.findViewById(R.id.str_cnt);
        TextView time = (TextView) convertView.findViewById(R.id.time);
        time.setText("pos: "+expanded_ListPosition);
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        ImageView h = (ImageView) convertView.findViewById(R.id.h);
        h.setVisibility(View.GONE);
        TextView listTitleTextView = (TextView) convertView.findViewById(R.id.str_cnt);

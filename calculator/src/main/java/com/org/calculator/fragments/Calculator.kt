...
class Calculator : Fragment() {
    ...
    override fun onCreateView(
        ...
        var root=  inflater.inflate(R.layout.fragment_calculator, container, false)

        tvsec = root.findViewById(R.id.idTVSecondary)
        tvMain = root.findViewById(R.id.idTVprimary)
        bac = root.findViewById(R.id.bac)
        bc = root.findViewById(R.id.bc)
        bbrac1 = root.findViewById(R.id.bbrac1)
        bbrac2 = root.findViewById(R.id.bbrac2)
        bsin = root.findViewById(R.id.bsin)
        bcos = root.findViewById(R.id.bcos)
        btan = root.findViewById(R.id.btan)
        blog = root.findViewById(R.id.blog)
        bln = root.findViewById(R.id.bln)
        bfact = root.findViewById(R.id.bfact)
        bsquare = root.findViewById(R.id.bsquare)
        bsqrt = root.findViewById(R.id.bsqrt)
        binv = root.findViewById(R.id.binv)
        b0 = root.findViewById(R.id.b0)
        b9 = root.findViewById(R.id.b9)
        b8 = root.findViewById(R.id.b8)
        b7 = root.findViewById(R.id.b7)
        ...
        bpi = root.findViewById(R.id.bpi)
        bmul = root.findViewById(R.id.bmul)
        bminus = root.findViewById(R.id.bminus)
        bplus = root.findViewById(R.id.bplus)
        bequal = root.findViewById(R.id.bequal)
        bdot = root.findViewById(R.id.bdot)
        bdiv = root.findViewById(R.id.bdiv)

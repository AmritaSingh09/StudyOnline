...
public class CalenderView extends LinearLayout {
    ...
    public CalenderView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.cal_view, this, true);
